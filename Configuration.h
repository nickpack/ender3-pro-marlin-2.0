...
#define STRING_CONFIG_H_AUTHOR "Nick Pack" // Who made the changes.
...
#define MACHINE_UUID "4c003ff6-8751-47b5-af77-23783a4fa902"
...
#define BLTOUCH
/**
 * I need to wire this in directly, but didn't check the internet before I installed it!
 */
